...
var useInsertionEffect = import_react.useInsertionEffect || useIsomorphicLayoutEffect;
var useEvent = (fn) => {
  const ref = (0, import_react.useRef)([fn, (...args) => ref[0](...args)]).current;
  useInsertionEffect(() => {
    ref[0] = fn;
  });
  return ref[1];
...
var useLocationProperty = (fn) => (0, import_shim.useSyncExternalStore)(subscribeToLocationUpdates, fn);
var currentPathname = () => location.pathname;
var usePathname = () => useLocationProperty(currentPathname);
var navigate = (to, { replace = false } = {}) => history[replace ? eventReplaceState : eventPushState](null, "", to);
var use_location_default = (opts = {}) => [
...
var Router = ({ hook, matcher, base = "", parent, children }) => {
  ...
  const [value] = (0, import_react2.useState)(
    () => updateRouter({
